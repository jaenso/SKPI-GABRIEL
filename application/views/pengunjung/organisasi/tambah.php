                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                            ...
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>Jabatan</label>
                                    <input required type="text" class="form-control" name="peran" placeholder="Jabatan dalam kegiatan yang diikuti. Contoh. Peserta , Panitia">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" class="form-control" name="penyelenggara" placeholder="Penyelenggaraan kegiatan yang diikuti">
                                </div>
                                <div class="form-group">
