                        ...
                        <div class="box box-primary">
                            ...
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div style="margin:10px" class="callout callout-success">
                                    ...
                                    <p>
                                        [1] Keikutsertaan Pertemuan Ilmiah/Seminar/Kuliah Umum/Lokakarya adalah yang <b><u>DIPEROLEH SELAMA MENJADI MAHASISWA</b></u><br>
                                ...
                                <div class="form-group">
                                    <label>Peran</label>
                                    <input required type="text" class="form-control" name="peran" placeholder="Peran dalam kegiatan yang diikuti. Contoh. Peserta , Panitia">
                                </div>
                                <div class="form-group">
