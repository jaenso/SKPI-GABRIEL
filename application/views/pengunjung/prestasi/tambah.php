                        ...
                        <div class="box box-primary">
                            ...
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div style="margin:10px" class="callout callout-success">
                                    ...
                                    <p>
                                        [1] Keikutsertaan Lomba/Prestasi Mahasiswa/Beasiswa adalah yang <b><u>DIPEROLEH SELAMA MENJADI MAHASISWA</b></u><br>
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" class="form-control" name="peran" placeholder="Prestasi dalam kegiatan yang diikuti. Contoh. Juara I , Juara 2">
                                </div>
                                <div class="form-group">
