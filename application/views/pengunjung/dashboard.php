      ...
      <div class="card card-info">
        ...
        <div class="callout callout-info">
          ...
          <p>Ayo Lengkapi Data Profil Kamu
            <a href="index.php?menu=5787be38ee03a9ae5360f54d9026465f&act=edit&id_mahasiswa=bGw%3D" class="btn bg-purple btn-flat">Disini!</a>
          </p>
        </div>
        <div class="card-body">
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" value="PALANGKARAYA, 07 November 1990" disabled>
          </div>
          <div class="input-group mb-3">
            <div class="input-group-prepend">
              <button class="btn btn-secondary">Nomor Ponsel</button>
            </div>
            <input type="text" class="form-control" value="12345678989" disabled>
          </div>
          <div class="input-group mb-3">
            <div class="input-group-prepend">
          ...
          <div class="input-group mb-3">
            ...
            <img src="codes/mhs/536546ft logo.jfif" width="30%">
          </div>
        </div>
      </div>
    </div>
